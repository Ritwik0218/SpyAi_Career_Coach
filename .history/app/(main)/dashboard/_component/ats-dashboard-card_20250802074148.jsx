  ...
  return (
    <Card className="bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200 hover:shadow-lg transition-all duration-200 hover:scale-[1.02]">
      ...
      <CardContent className="space-y-4">
        ...
        {/* Stats Preview */}
        <div className="grid grid-cols-3 gap-2 md:gap-3 pt-3 border-t border-blue-200">
          <div className="text-center">
            <div className="flex items-center justify-center gap-1">
              <Target className="h-3 w-3 md:h-4 md:w-4 text-blue-600" />
              <span className="text-base md:text-lg font-bold text-blue-900">95%</span>
            </div>
            <p className="text-[10px] md:text-xs text-blue-600">Max ATS Score</p>
          </div>
          <div className="text-center">
            <div className="flex items-center justify-center gap-1">
              <TrendingUp className="h-3 w-3 md:h-4 md:w-4 text-green-600" />
              <span className="text-base md:text-lg font-bold text-green-700">+35</span>
            </div>
            <p className="text-[10px] md:text-xs text-blue-600">Avg Improvement</p>
          </div>
          <div className="text-center">
            <div className="flex items-center justify-center gap-1">
              <Award className="h-3 w-3 md:h-4 md:w-4 text-purple-600" />
              <span className="text-base md:text-lg font-bold text-purple-700">A+</span>
            </div>
            <p className="text-[10px] md:text-xs text-blue-600">Grade Rating</p>
          </div>
        </div>

        {/* Success Stories */}
        <div className="bg-gradient-to-r from-green-100 to-blue-100 p-2 md:p-3 rounded-lg">
          <p className="text-[10px] md:text-xs text-green-800 font-medium">
